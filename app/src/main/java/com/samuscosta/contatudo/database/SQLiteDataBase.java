...
public class SQLiteDataBase {
    ...
    //Contador
    private static final String CONTADOR = "CREATE TABLE IF NOT EXISTS " + Contador_Model.NOME_TABELA + " ( " +
            ...
            ", " + Contador_Model.VALOR_MINIMO + " NUMERIC DEFAULT 0 " +
            ", " + Contador_Model.VALOR_MAXIMO + " NUMERIC DEFAULT 0 " +
            ", " + Contador_Model.USAR_MINIMO + " NUMERIC DEFAULT 0 " +
            ", " + Contador_Model.USAR_MAXIMO + " NUMERIC DEFAULT 0 " +
            " )";
    ...
    public static final String NOME_BANCO = "dbContadorGeral";
